...
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/blocks.js
...
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/inlines.js
var require_inlines = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/marks.js
var require_marks = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/schemaConstraints.js
var require_schemaConstraints = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var _obj;
	var CONTAINERS = (_obj = {}, _define_property(_obj, _blocks.BLOCKS.OL_LIST, [_blocks.BLOCKS.LIST_ITEM]), _define_property(_obj, _blocks.BLOCKS.UL_LIST, [_blocks.BLOCKS.LIST_ITEM]), _define_property(_obj, _blocks.BLOCKS.LIST_ITEM, LIST_ITEM_BLOCKS), _define_property(_obj, _blocks.BLOCKS.QUOTE, [_blocks.BLOCKS.PARAGRAPH]), _define_property(_obj, _blocks.BLOCKS.TABLE, [_blocks.BLOCKS.TABLE_ROW]), _define_property(_obj, _blocks.BLOCKS.TABLE_ROW, [_blocks.BLOCKS.TABLE_CELL, _blocks.BLOCKS.TABLE_HEADER_CELL]), _define_property(_obj, _blocks.BLOCKS.TABLE_CELL, [
		_blocks.BLOCKS.PARAGRAPH,
		_blocks.BLOCKS.UL_LIST,
		_blocks.BLOCKS.OL_LIST
	]), _define_property(_obj, _blocks.BLOCKS.TABLE_HEADER_CELL, [_blocks.BLOCKS.PARAGRAPH]), _obj);
	var HEADINGS = [
		_blocks.BLOCKS.HEADING_1,
		_blocks.BLOCKS.HEADING_2,
		_blocks.BLOCKS.HEADING_3,
	...
	var TEXT_CONTAINERS = [_blocks.BLOCKS.PARAGRAPH].concat(_to_consumable_array(HEADINGS));
	var V1_NODE_TYPES = [
...
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/types.js
var require_types = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/nodeTypes.js
var require_nodeTypes = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/emptyDocument.js
var require_emptyDocument = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/helpers.js
var require_helpers = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function hasValue(obj, value) {
		...
		try {
			for (var _iterator = Object.keys(obj)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) if (value === obj[_step.value]) return true;
		} catch (err) {
	...
	function isEmptyParagraph(node) {
		if (node.nodeType !== _blocks.BLOCKS.PARAGRAPH) return false;
	...
	function stripEmptyTrailingParagraphFromDocument(document) {
		if (!isValidDocument(document) || document.content.length < MIN_NODES_FOR_STRIPPING) return document;
		var lastNode = document.content[document.content.length - 1];
		if (isEmptyParagraph(lastNode)) return _object_spread_props(_object_spread({}, document), { content: document.content.slice(0, -1) });
		return document;
	}
}));
//#endregion
...
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/validator/errors.js
var require_errors = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var minSizeError = function(param) {
		var min = param.min, value = param.value;
		return {
			name: "size",
			min,
			path: param.path.toArray(),
			details: "Size must be at least ".concat(min),
			value
		};
	};
	var maxSizeError = function(param) {
		var max = param.max, value = param.value;
		return {
			name: "size",
			max,
			path: param.path.toArray(),
...
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/validator/assert.js
var require_assert = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var _isplainobj = /* @__PURE__ */ _interop_require_default(require_is_plain_obj());
	...
	var ObjectAssertion = /* @__PURE__ */ function() {
		...
		function ObjectAssertion(obj, path) {
			...
			this._errors = [];
			this.catch = function() {
				for (var _len = arguments.length, errors = new Array(_len), _key = 0; _key < _len; _key++) errors[_key] = arguments[_key];
				var _this__errors;
				(_this__errors = _this1._errors).push.apply(_this__errors, _to_consumable_array(errors));
			};
			this.exists = function(key) {
				if (key in _this.obj) return true;
			...
			this.object = function(key) {
				...
				if (key) {
					if (!_this.exists(key)) return false;
				}
				if ((0, _isplainobj.default)(value)) return true;
			...
			this.string = function(key) {
				...
				if (key && !_this.exists(key)) return false;
			...
			this.number = function(key, optional) {
				var value = _this.obj[key];
				if (optional && !(key in _this.obj)) return true;
				if (!_this.exists(key)) return false;
			...
			this.empty = function(key) {
				if (!_this.array(key)) return false;
				var value = _this.obj[key];
...
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/validator/node.js
var require_node = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var NodeAssertion = /* @__PURE__ */ function() {
		...
		_create_class(NodeAssertion, [{
			...
			value: function assert(node, path) {
				...
				var _ref = Array.isArray(this.contentRule) ? { nodeTypes: this.contentRule } : this.contentRule(node, path), nodeTypes = _ref.nodeTypes, _ref_min = _ref.min, min = _ref_min === void 0 ? 0 : _ref_min;
				if (nodeTypes.length === 0 && min > 0) throw new Error("Invalid content rule. Cannot have enforce a 'min' of ".concat(min, " with no nodeTypes"));
				$.minLength("content", min);
				if (nodeTypes.length === 0) $.empty("content");
				else $.each("content", function(item, path) {
					var item$ = new _assert.ObjectAssertion(item, path);
					if (!item$.object()) return item$.errors;
	...
	var EntityLinkAssertion = /* @__PURE__ */ function(NodeAssertion) {
		...
		function EntityLinkAssertion(linkType, contentNodeTypes) {
			...
			var _this = _call_super(this, EntityLinkAssertion, [contentNodeTypes, function(data, path) {
	...
	var HyperLinkAssertion = /* @__PURE__ */ function(NodeAssertion) {
		...
		function HyperLinkAssertion() {
			...
			var _this = _call_super(this, HyperLinkAssertion, [["text"], function(data, path) {
				return _assert_this_initialized(_this).assertLink(data, path);
			}]);
...
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/validator/path.js
var require_path = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var Path = function Path() {
		...
		this.of = function(element) {
			return new Path(_to_consumable_array(_this.path).concat([element]));
		};
...
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/validator/text.js
var require_text = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function assertText(text, path) {
		...
		$.each("marks", function(mark, path) {
			...
			if (!mark$.object()) return mark$.errors;
			mark$.string("type");
			return mark$.errors;
		});
		$.string("value");
...
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/validator/index.js
var require_validator = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var assertInlineOrText = (0, _node.assert)(_to_consumable_array(Object.values(_inlines.INLINES)).concat(["text"]).sort());
	var assertList = (0, _node.assert)([_blocks.BLOCKS.LIST_ITEM]);
	var assertVoidEntryLink = (0, _node.assertLink)("Entry", _node.VOID_CONTENT);
	var assertTableCell = (0, _node.assert)(function() {
		return {
			nodeTypes: [_blocks.BLOCKS.PARAGRAPH],
			min: 1
		};
	}, function(data, path) {
		var $ = new _assert.ObjectAssertion(data, path);
	...
	var nodeValidator = (_obj = {}, _define_property(_obj, _blocks.BLOCKS.DOCUMENT, (0, _node.assert)(_schemaConstraints.TOP_LEVEL_BLOCKS)), _define_property(_obj, _blocks.BLOCKS.PARAGRAPH, assertInlineOrText), _define_property(_obj, _blocks.BLOCKS.HEADING_1, assertInlineOrText), _define_property(_obj, _blocks.BLOCKS.HEADING_2, assertInlineOrText), _define_property(_obj, _blocks.BLOCKS.HEADING_3, assertInlineOrText), _define_property(_obj, _blocks.BLOCKS.HEADING_4, assertInlineOrText), _define_property(_obj, _blocks.BLOCKS.HEADING_5, assertInlineOrText), _define_property(_obj, _blocks.BLOCKS.HEADING_6, assertInlineOrText), _define_property(_obj, _blocks.BLOCKS.QUOTE, (0, _node.assert)(_schemaConstraints.CONTAINERS[_blocks.BLOCKS.QUOTE])), _define_property(_obj, _blocks.BLOCKS.EMBEDDED_ENTRY, assertVoidEntryLink), _define_property(_obj, _blocks.BLOCKS.EMBEDDED_ASSET, (0, _node.assertLink)("Asset", _node.VOID_CONTENT)), _define_property(_obj, _blocks.BLOCKS.EMBEDDED_RESOURCE, (0, _node.assertLink)("Contentful:Entry", _node.VOID_CONTENT)), _define_property(_obj, _blocks.BLOCKS.HR, (0, _node.assert)(_node.VOID_CONTENT)), _define_property(_obj, _blocks.BLOCKS.OL_LIST, assertList), _define_property(_obj, _blocks.BLOCKS.UL_LIST, assertList), _define_property(_obj, _blocks.BLOCKS.LIST_ITEM, (0, _node.assert)(_to_consumable_array(_schemaConstraints.LIST_ITEM_BLOCKS).sort())), _define_property(_obj, _blocks.BLOCKS.TABLE, (0, _node.assert)(function() {
		return {
			nodeTypes: [_blocks.BLOCKS.TABLE_ROW],
			min: 1
		};
	})), _define_property(_obj, _blocks.BLOCKS.TABLE_ROW, (0, _node.assert)(function() {
		return {
			nodeTypes: [_blocks.BLOCKS.TABLE_CELL, _blocks.BLOCKS.TABLE_HEADER_CELL],
			min: 1
		};
	})), _define_property(_obj, _blocks.BLOCKS.TABLE_CELL, assertTableCell), _define_property(_obj, _blocks.BLOCKS.TABLE_HEADER_CELL, assertTableCell), _define_property(_obj, _inlines.INLINES.HYPERLINK, new _node.HyperLinkAssertion()), _define_property(_obj, _inlines.INLINES.EMBEDDED_ENTRY, assertVoidEntryLink), _define_property(_obj, _inlines.INLINES.EMBEDDED_RESOURCE, (0, _node.assertLink)("Contentful:Entry", _node.VOID_CONTENT)), _define_property(_obj, _inlines.INLINES.ENTRY_HYPERLINK, (0, _node.assertLink)("Entry", ["text"])), _define_property(_obj, _inlines.INLINES.ASSET_HYPERLINK, (0, _node.assertLink)("Asset", ["text"])), _define_property(_obj, _inlines.INLINES.RESOURCE_HYPERLINK, (0, _node.assertLink)("Contentful:Entry", ["text"])), _obj);
	function validateNode(node, path) {
		if (node.nodeType === "text") return (0, _text.assertText)(node, path);
	...
	var validateRichTextDocument = function(document) {
		...
		if ($.object()) $.enum("nodeType", [_blocks.BLOCKS.DOCUMENT]);
		if ($.errors.length > 0) return $.errors;
		return validateNode(document, path);
	};
}));
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/node_modules/@contentful/rich-text-types/dist/cjs/index.js
var require_cjs = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var _helpers = /* @__PURE__ */ _interop_require_wildcard(require_helpers());
...
//#endregion
//#region node_modules/@contentful/rich-text-react-renderer/dist/rich-text-react-renderer.es5.js
var require_rich_text_react_renderer_es5 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var React = require_react();
	var richTextTypes = require_cjs();
	function appendKeyToValidElement(element, key) {
		if (React.isValidElement(element) && element.key === null) return React.cloneElement(element, { key });
		return element;
	}
	...
	function nodeToReactComponent(node, options) {
		...
		if (richTextTypes.helpers.isText(node)) {
			...
			if (preserveWhitespace && !renderText) {
				nodeValue = nodeValue.replace(/ {2,}/g, (match) => "\xA0".repeat(match.length));
				const lines = nodeValue.split("\n");
				const jsxLines = [];
				lines.forEach((line, index) => {
					jsxLines.push(line);
					if (index !== lines.length - 1) jsxLines.push(React.createElement("br", null));
				});
				nodeValue = jsxLines;
			}
			return node.marks.reduce((value, mark) => {
				if (!renderMark[mark.type]) return value;
				return renderMark[mark.type](value);
			}, nodeValue);
		} else {
			const children = nodeListToReactComponents(node.content, options);
			if (!node.nodeType || !renderNode[node.nodeType]) return React.createElement(React.Fragment, null, children);
	...
	var defaultNodeRenderers = {
		...
		[richTextTypes.INLINES.HYPERLINK]: (node, children) => React.createElement("a", { href: node.data.uri }, children)
	};
	...
	function defaultInline(type, node) {
		return React.createElement("span", { key: node.data.target.sys.id }, "type: ", node.nodeType, " id: ", node.data.target.sys.id);
	}
	function defaultInlineResource(type, node) {
		return React.createElement("span", { key: node.data.target.sys.urn }, "type: ", node.nodeType, " urn: ", node.data.target.sys.urn);
	}
	function documentToReactComponents(richTextDocument, options = {}) {
		if (!richTextDocument) return null;
		let processedDocument = richTextDocument;
		if (options.stripEmptyTrailingParagraph) processedDocument = richTextTypes.helpers.stripEmptyTrailingParagraphFromDocument(richTextDocument);
